...
if __name__ == '__main__':
    ...
    newTool = Tool(name='Mask', job_id = job.id, description='A tool that cuts wires', owner='default')
    session.add(newTool)
    newTool = Tool(name='Torch', job_id = job.id, description='A tool that cuts wires', owner='default')
    session.add(newTool)
