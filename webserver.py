...
@app.route('/')
def home():
    print hasattr(login_session, 'access_token'), hasattr(login_session, 'facebook_id')
    print login_session['access_token']
    retval = render_template('header.html', loggedin=hasattr(login_session, 'access_token'), fb=hasattr(login_session, 'facebook_id'))
